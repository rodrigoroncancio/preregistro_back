...
from ..models import FormCatatumbosFichaAcuerdo, FormCatatumnoFichaAcuerdoNucleoFamiliar
...
class FormCatatumboFichaAcuerdoNucleoFamiliarSerializer(serializers.ModelSerializer):
    foto_doc_frente = BaseFileMixin.base64_file()
    foto_doc_atras = BaseFileMixin.base64_file()
    class Meta:
